  ...
  return knex('albums').del()
    .then(function () {
      ...
      return knex('albums').insert([{
        ...
        artist: 1,
        condition: 'Average',
        notes: 'This is one of my all time favourite albums. Really can\'t beat listening to the opening with it\'s wild thumping heartbeat at ear bleeding volume. A wonder in modern musical production.\nVinyl in okay condition, sleeve fairly tatty.',
